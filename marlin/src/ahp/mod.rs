...
impl<F: PrimeField> AHP<F> {
    ...
    pub fn max_degree(
        ...
        let domain_h_size = GeneralEvaluationDomain::<F>::compute_size_of_domain(num_padded)
            .ok_or(SynthesisError::PolynomialDegreeTooLarge)?;
        let domain_k_size = GeneralEvaluationDomain::<F>::compute_size_of_domain(num_non_zeros)
            .ok_or(SynthesisError::PolynomialDegreeTooLarge)?;
        Ok(*[
