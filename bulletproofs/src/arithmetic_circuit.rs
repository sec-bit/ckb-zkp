    ...
    R: Rng,
{
    ...
    transcript.append_message(b"A_I", &to_bytes!(A_I).unwrap());
    transcript.append_message(b"A_O", &to_bytes!(A_O).unwrap());
    transcript.append_message(b"A_W", &to_bytes!(A_W).unwrap());
    transcript.append_message(b"S", &to_bytes!(S).unwrap());
    ...
    transcript.append_message(b"T_2", &to_bytes!(T_2).unwrap());
    transcript.append_message(b"T_3", &to_bytes!(T_3).unwrap());
    transcript.append_message(b"T_5", &to_bytes!(T_5).unwrap());
    transcript.append_message(b"T_6", &to_bytes!(T_6).unwrap());
    transcript.append_message(b"T_7", &to_bytes!(T_7).unwrap());
    transcript.append_message(b"T_8", &to_bytes!(T_8).unwrap());
    transcript.append_message(b"T_9", &to_bytes!(T_9).unwrap());
    transcript.append_message(b"T_10", &to_bytes!(T_10).unwrap());
...
pub fn verify_proof<G: Curve>(
    ...
    transcript.append_message(b"A_W", &to_bytes!(proof.A_W).unwrap());
    transcript.append_message(b"S", &to_bytes!(proof.S).unwrap());
    ...
    // V challenge x
    transcript.append_message(b"T_2", &to_bytes!(proof.T_2).unwrap());
    transcript.append_message(b"T_3", &to_bytes!(proof.T_3).unwrap());
    transcript.append_message(b"T_5", &to_bytes!(proof.T_5).unwrap());
    transcript.append_message(b"T_6", &to_bytes!(proof.T_6).unwrap());
    transcript.append_message(b"T_7", &to_bytes!(proof.T_7).unwrap());
    transcript.append_message(b"T_8", &to_bytes!(proof.T_8).unwrap());
    transcript.append_message(b"T_9", &to_bytes!(proof.T_9).unwrap());
    transcript.append_message(b"T_10", &to_bytes!(proof.T_10).unwrap());
    ...
    let P = proof.A_I.mul(xx)
        + &proof.A_O.mul(xx * &x)
        + &proof.A_W.mul(xxxx)
        + &(quick_multiexp::<G>(&y_n_neg, &h_vec_inv).mul(x.into()))
        + &wL.mul(xx.into())
        + &wR.mul(xx.into())
        + &wO.mul(x.into())
        + &wV
