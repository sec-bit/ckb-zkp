...
use crate::{
    curves::{ModelParameters, PairingEngine, SWModelParameters},
    fields::{
        Field, Fp12, Fp12Parameters, Fp2, Fp2Parameters, Fp6Parameters, PrimeField, SquareRootField,
    },
};

pub trait BnParameters: 'static + Send + Sync {
