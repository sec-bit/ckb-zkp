...
use zkp_r1cs::{ConstraintSystem, SynthesisError};

use crate::Vec;

use crate::algebra::{boolean::Boolean, uint32::UInt32};
...
fn mixing_g<F: PrimeField, CS: ConstraintSystem<F>, M>(
    mut cs: M,
    v: &mut [UInt32],
    a: usize,
    b: usize,
...
pub fn blake2s<F: PrimeField, CS: ConstraintSystem<F>>(
    mut cs: CS,
    input: &[Boolean],
    personalization: &[u8],
...
mod test {
    ...
    fn test_blank_hash() {
        ...
        // >>> h.hexdigest()
        let expected =
            hex_literal::hex!("c59f682376d137f3f255e671e207d1f2374ebe504e9314208a52d9f88d69e8c8");
    ...
    fn test_blake2s_256_vars() {
        let data: Vec<u8> = hex_literal::hex!("").to_vec();
        ...
        let expected =
            hex_literal::hex!("0af5695115ced92c8a0341e43869209636e9aa6472e4576f0f2b996cf812b30e");
    ...
    fn test_blake2s_700_vars() {
        let data: Vec<u8> = hex_literal::hex!("").to_vec();
        ...
        let expected =
            hex_literal::hex!("2ab8f0683167ba220eef19dccf4f9b1a8193cc09b35e0235842323950530f18a");
    ...
    fn test_blake2s_test_vectors() {
        ...
        let expecteds = [
            hex_literal::hex!("117b8bc6b907fa928ba4cca3071c4212b3a240adcf3dea8b08d09b865fda51bd"),
            hex_literal::hex!("34bf1e4774d3d1722e6f057877d4dd2956e4f7406d41bd1b8d4ca8dc7177783e"),
        ];
